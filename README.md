...
- ⚽ Fora do código: Entusiasta de futebol e amante de animais.
...
* **SGO - Gestão de Oficina:** Sistema Full-Stack académico para gestão de fluxos de trabalho e inventário.
* **Gostos d'Arrábida:** Aplicação web para gestão de reservas e e-menu com geração de QR Code.
* **ASYDIM:** Solução digital focada em consultoria e formação sustentável.
...
<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=hmsousa10&theme=omni&border_radius=10" alt="GitHub Streak" />
</div>
...
Se tens uma ideia para um projeto ou queres apenas trocar ideias sobre tecnologia, não hesites em contactar!
